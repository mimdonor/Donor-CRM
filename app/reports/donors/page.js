  ...
  const fetchDropdownOptions = async () => {
    try {
      const [
        ...
        supabase.from("donorsource_dropdown").select("*").eq("status", true),
        supabase.from("donorzone_dropdown").select("*").eq("status", true),
        supabase.from("representatives_dropdown").select("*").eq("status", true),
      ]);
  ...
  const resetFilters = () => {
    setFilters({
      ...
      category: "",
                    ...
                    console.log("Category", dropdownOptions.categories)
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="w-[200px]">
                <MultiSelect
                  ...
                  onChange={(selected) =>
                    setFilters((prev) => ({ ...prev, donorSources: selected }))
                  }
              ...
              <div className="space-y-2 w-[200px]">
                <MultiSelect
                  ...
                  onChange={(selected) =>
                    setFilters((prev) => ({ ...prev, representatives: selected }))
                  }
              ...
              <div className="w-[200px]">
               <MultiSelect
                  ...
                  onChange={(selected) =>
                    setFilters((prev) => ({
                      ...prev,
                      category: selected.length > 0 ? selected[0] : "",
                    }))
                  }
