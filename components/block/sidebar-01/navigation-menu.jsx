    ...
    (<li key={item.url} className="w-full">
      {item.children ? (
        <button
          ...
          <item.icon
            className="text-foreground/70 group/nav-link-hover:text-primary-foreground size-6" />
      ...
      before:border-b-foreground/30 before:rounded-bl-[50%] before:border-t-0 before:border-r-0`,
              ...
              <a
                ...
                href={child.url}>
                <child.icon
                  className="text-foreground/70 size-5 group/nav-link-hover:text-primary-foreground" />
