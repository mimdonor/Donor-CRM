    ...
    (<Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        ...
        <div className="relative w-[50px]">
          ...
          <div
            className="absolute bottom-0 right-0 p-[2px] bg-black text-white size-4 ring-white ring-[1.5px] rounded-sm">
...
const UserInfo = ({
  ...
  return (
    (<button
      ...
      <div
        className="text-start min-w-[150px] flex flex-1 flex-col h-full justify-center">
